...
const SectionBenefits = () => {
    return (
        <div>
            <img className={styles.BenefitsBannerImg} src={benefitsImg} alt="bicycle" />
            <div className={styles.BenefitsWrapper}>
                <div className={classNames(styles.BenefitItems, 'container') }>
                    ...
                    <div className={styles.benefitsItem}>
                        ...
                        <span>Pre-sale setup Specialists will set up your bike in the best possible way</span>
                    </div>

                    <div className={styles.benefitsItem}>
                        <div className={styles.benefitsSubtitleWrapp}>
                            <img className={styles.benefitsIcon} src={benefFour} alt="" />
                            <span className={styles.benefitsSubtitle}>Delivery in 24 hours</span>
                        </div>
