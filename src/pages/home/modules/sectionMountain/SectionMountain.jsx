        ...
        <div className="container">
            ...
            <div className={styles.mountain}>
                <div className={styles.mountainSliderWrapp}>
                    <SliderSimple itemsList={mountCardsData} SliderItemComponent={InfoCard}/>
                </div>
                    ...
                    <div className={styles.mountainItems}>
                        <div className={styles.mountainItem}>
                            <div className={styles.mountainTitleWrapp}>
                                ...
                                <img className={styles.mountainIcon} src={mountOne} alt="Equipment" />
                            </div>
                        ...
                        <div className={styles.mountainItem}>
                            <div className={styles.mountainTitleWrapp}>
                                ...
                                <img className={styles.mountainIcon} src={mountTwo} alt="Transmission" />
                            </div>
                            <span>Many desktop publishing packages and web page editors now use lorem ipsum as </span>
                        </div>
                    </div>
                    ...
                    <div className={styles.mountainItems}>
                        <div className={styles.mountainItem}>
                            <div className={styles.mountainTitleWrapp}>
                                ...
                                <img className={styles.mountainIcon} src={mountThree} alt="computer" />
                            </div>
                        ...
                        <div className={styles.mountainItem}>
                            <div className={styles.mountainTitleWrapp}>
                                ...
                                <img className={styles.mountainIcon} src={mountFour} alt="Frame" />
                            </div>
                ...
                <div className={styles.mountainWrapper}>
                    ...
                    <div className={styles.mountainDesc}>Mountain bike, despite its name, is often and actively used in urban conditions, as it has a number of character</div>
