        ...
        <div className={styles.detailsWrapper}>
            <div className="container">
                ...
                <div className={styles.detailsSlider}>
                    <SliderSimple itemsList={detailsCardsData} SliderItemComponent={(props) => <InfoCard {...props} bgColor={true}/>}/>
                </div>
                ...
                <div className={styles.details}>
                    ...
                    <div className={styles.detailsItemsWrapp}>
                        ...
                        <div className={classNames(styles.detailsItems, styles.ItemsSecond)}>
                            <div className={styles.detailsItem}>
                                <div className={styles.detailsTitleWrapp}>
