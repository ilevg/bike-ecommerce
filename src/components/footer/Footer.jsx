        ...
        <div className="container">
          <div>
            ...
            <div className={styles.footerSubWrapper}>
              <input type="email" placeholder='E-mail' className={styles.footerSubInput} />
            ...
            <div>
              ...
              <span className={styles.checkboxLable}>I agree to the processing of personal data</span>
            </div>
          </div>

          <div className={styles.footerBody}>
            <div>
              <Link to='/'><img src={logo} alt="logo" className={styles.foterLogo} /></Link>
              <span className={styles.footerLogoDesc}>The World-bikes company specializes in the sale of cycling products.</span>
            </div>
            ...
            <div className={styles.footerContent}>
              ...
              <div className={classNames(styles.footerLinksWrapper, styles.footerLinksSec)}>
                <h4 className={styles.footerLinksTitle}>For the client</h4>
                <ul className={styles.footerLinksList}>
                  <li> <LinkTag to='/catalog' text='ABOUT US' color=''></LinkTag> </li>
                  <li><LinkTag to='/bicycles' text='DELIVERY AND PAYMENT' color=''></LinkTag></li>
                  <li><LinkTag to='/equipment' text='BLOG' color=''></LinkTag></li>
                  <li><LinkTag to='/accessories' text='CONTACTS' color=''>Contacts</LinkTag></li>
                </ul>
              </div>
              <div className={styles.footerLinksWrapper}>
                ...
                <ul className={styles.footerLinksList}>
                  ...
                  <li className={styles.foterListItem}>
                    ...
                    <div>
                      <a href='https://maps.app.goo.gl/NrY2DcMgqxB6ygVa7'>London,<br />Centrum str, 7/8</a>
                    </div>
                  </li>
                  <li className={styles.foterListItem}>
